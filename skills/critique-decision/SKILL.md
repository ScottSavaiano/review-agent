...
- **The end-of-initiation setup outputs** — the close of **Block A (project identity** — the research problem's framing) and **Block B (methods setup** — the core+extension method selection): is the problem well-posed, are the chosen methods appropriate to it.
